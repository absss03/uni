...
# ------------------------------
def menu_opcion_2(opcion_menu_principal, saldo_pesos, saldo_soles, clave_ingresada):
  clave_ingresada=0
  saldo=0
  while opcion_menu_principal == 2:
    ...
    #--------------------------------------------------------
      ...
      if confirma('salir') == "S":        #El monto exede el saldo, ¿quiere salir?
        opcion_menu_principal=0
      else:
        #--------------------------------------------------------
        monto_a_retirar = int(input("Ingrese monto a retirar 2: "))       #Si se queda puede modificar el monto 1 sola vez 
        if monto_a_retirar < saldo:
          while clave_ingresada != clave:
            clave_ingresada= int(input("ingrese su clave: "))
            if clave_ingresada == clave: 
  ...
  return saldo
# ------------------------------
def menu_opcion_3(opcion_menu_principal, saldo_pesos, saldo_soles, cuenta_ingresada, devolucion):
...
while reintentos<3 and opcion_menu_principal!=4 and dni_ingresado==0:
  ...
  if clave_ingresada==clave and dni_ingresado==dni:
    ...
    while opcion_menu_principal!=4:
      ...
      # Menu Opcion 2
      #
      saldo=menu_opcion_2(opcion_menu_principal, saldo_pesos, saldo_soles, clave_ingresada)
      if moneda_elegida=='Pesos':
        saldo_pesos=saldo
      else:
        saldo_soles=saldo
      ...
      # Menu Opcion 3
      #
      saldo=menu_opcion_3(opcion_menu_principal, saldo_pesos, saldo_soles, cuenta_ingresada, devolucion)
      if moneda_elegida=='Pesos':
        saldo_pesos=saldo
